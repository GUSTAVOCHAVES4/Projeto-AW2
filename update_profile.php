...
if(isset($_POST['update_profile'])){
   ...
   if(!empty($update_image)){
      if($update_image_size > 2000000){
         $message[] = 'A imagem é muito larga';
      }else{
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="password" name="update_pass" placeholder="Insira sua senha antiga" class="box">
      ...
      <input type="submit" value="Atualizar informações" name="update_profile" class="btn">
