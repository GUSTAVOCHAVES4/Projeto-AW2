...
<div class="form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      ?>
      <input type="text" name="name" placeholder="Insira um nome de usuário" class="box" required>
      <input type="email" name="email" placeholder="Insira seu email" class="box" required>
      <input type="password" name="password" placeholder="Insira sua senha" class="box" required>
